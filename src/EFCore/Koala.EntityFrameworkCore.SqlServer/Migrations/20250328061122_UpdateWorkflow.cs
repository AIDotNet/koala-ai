        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, comment: "工作流名称"),
                    Description = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true, comment: "工作流描述"),
                    Version = table.Column<int>(type: "int", nullable: false, defaultValue: 1, comment: "工作流版本"),
                    Status = table.Column<int>(type: "int", nullable: false, defaultValue: 0, comment: "工作流状态"),
                    Definition = table.Column<string>(type: "nvarchar(max)", nullable: false, comment: "工作流定义（JSON格式）"),
                    ...
                    Tags = table.Column<string>(type: "nvarchar(max)", nullable: true, comment: "标签（JSON数组格式）"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false, comment: "实例ID")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ReferenceId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false, comment: "实例参考ID"),
                    WorkflowId = table.Column<long>(type: "bigint", nullable: false, comment: "工作流ID"),
                    WorkflowVersion = table.Column<int>(type: "int", nullable: false, comment: "工作流版本号"),
                    Status = table.Column<int>(type: "int", nullable: false, defaultValue: 0, comment: "实例状态"),
                    Data = table.Column<string>(type: "nvarchar(max)", nullable: true, comment: "实例数据（JSON格式）"),
                    CurrentNodeId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true, comment: "当前活动节点ID"),
                    StartTime = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false, comment: "开始时间"),
                    EndTime = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true, comment: "结束时间"),
                    ErrorMessage = table.Column<string>(type: "nvarchar(max)", nullable: true, comment: "错误信息"),
                    WorkflowCoreInstanceId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true, comment: "Workflow Core实例ID"),
                    Creator = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreationTime = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    Modifier = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ModificationTime = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false, comment: "节点ID")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NodeId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false, comment: "节点ID（在工作流内唯一）"),
                    Name = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, comment: "节点名称"),
                    NodeType = table.Column<int>(type: "int", nullable: false, comment: "节点类型"),
                    Configuration = table.Column<string>(type: "nvarchar(max)", nullable: true, comment: "节点配置（JSON格式）"),
                    WorkflowId = table.Column<long>(type: "bigint", nullable: false, comment: "工作流ID"),
                    PositionX = table.Column<double>(type: "float", nullable: false, defaultValue: 0.0, comment: "位置X坐标"),
                    PositionY = table.Column<double>(type: "float", nullable: false, defaultValue: 0.0, comment: "位置Y坐标"),
                    Creator = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreationTime = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    Modifier = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ModificationTime = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false, comment: "连接ID")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ConnectionId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false, comment: "连接ID（在工作流内唯一）"),
                    Name = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true, comment: "连接名称"),
                    WorkflowId = table.Column<long>(type: "bigint", nullable: false, comment: "工作流ID"),
                    ...
                    ConnectionType = table.Column<int>(type: "int", nullable: false, defaultValue: 0, comment: "连接类型"),
                    Condition = table.Column<string>(type: "nvarchar(max)", nullable: true, comment: "条件表达式"),
                    Creator = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreationTime = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    Modifier = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ModificationTime = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true)

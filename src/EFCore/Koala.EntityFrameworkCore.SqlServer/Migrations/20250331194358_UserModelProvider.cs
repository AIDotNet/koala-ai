    ...
    public partial class UserModelProvider : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false, comment: "用户模型提供者ID"),
                    ...
                    ModelType = table.Column<string>(type: "nvarchar(450)", nullable: false, comment: "模型类型"),
                    ApiKey = table.Column<string>(type: "nvarchar(max)", nullable: false, comment: "API密钥"),
                    Endpoint = table.Column<string>(type: "nvarchar(max)", nullable: false, comment: "API端点"),

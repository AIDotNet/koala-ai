    ...
    public partial class UpdateWorkflow : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "INTEGER", nullable: false, comment: "工作流ID")
                        .Annotation("Sqlite:Autoincrement", true),
                    Name = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false, comment: "工作流名称"),
                    Description = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true, comment: "工作流描述"),
                    ...
                    AgentId = table.Column<long>(type: "INTEGER", nullable: true, comment: "关联的智能体ID"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "INTEGER", nullable: false, comment: "实例ID")
                        .Annotation("Sqlite:Autoincrement", true),
                    ReferenceId = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false, comment: "实例参考ID"),
                    WorkflowId = table.Column<long>(type: "INTEGER", nullable: false, comment: "工作流ID"),
                    ...
                    CurrentNodeId = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true, comment: "当前活动节点ID"),
                    StartTime = table.Column<DateTimeOffset>(type: "TEXT", nullable: false, comment: "开始时间"),
                    EndTime = table.Column<DateTimeOffset>(type: "TEXT", nullable: true, comment: "结束时间"),
                    ErrorMessage = table.Column<string>(type: "TEXT", nullable: true, comment: "错误信息"),
                    WorkflowCoreInstanceId = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true, comment: "Workflow Core实例ID"),
                    Creator = table.Column<string>(type: "TEXT", nullable: true),
                    CreationTime = table.Column<DateTimeOffset>(type: "TEXT", nullable: true),
                    Modifier = table.Column<string>(type: "TEXT", nullable: true),
                    ModificationTime = table.Column<DateTimeOffset>(type: "TEXT", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "INTEGER", nullable: false, comment: "节点ID")
                        .Annotation("Sqlite:Autoincrement", true),
                    NodeId = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false, comment: "节点ID（在工作流内唯一）"),
                    Name = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false, comment: "节点名称"),
                    ...
                    WorkflowId = table.Column<long>(type: "INTEGER", nullable: false, comment: "工作流ID"),
                    PositionX = table.Column<double>(type: "REAL", nullable: false, defaultValue: 0.0, comment: "位置X坐标"),
                    PositionY = table.Column<double>(type: "REAL", nullable: false, defaultValue: 0.0, comment: "位置Y坐标"),
                    Creator = table.Column<string>(type: "TEXT", nullable: true),
                    CreationTime = table.Column<DateTimeOffset>(type: "TEXT", nullable: true),
                    Modifier = table.Column<string>(type: "TEXT", nullable: true),
                    ModificationTime = table.Column<DateTimeOffset>(type: "TEXT", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "INTEGER", nullable: false, comment: "连接ID")
                        .Annotation("Sqlite:Autoincrement", true),
                    ConnectionId = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false, comment: "连接ID（在工作流内唯一）"),
                    Name = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true, comment: "连接名称"),
                    WorkflowId = table.Column<long>(type: "INTEGER", nullable: false, comment: "工作流ID"),
                    SourceNodeId = table.Column<long>(type: "INTEGER", nullable: false, comment: "源节点ID"),
                    TargetNodeId = table.Column<long>(type: "INTEGER", nullable: false, comment: "目标节点ID"),

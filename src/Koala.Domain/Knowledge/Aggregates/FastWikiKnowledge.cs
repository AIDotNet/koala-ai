...
public class KoalaKnowledge : AuditEntity<string>
{
    ...
    public KoalaKnowledge(string name, string description, string avatar, string embeddingModel, string chatModel,
        string? categoryId)
    {
